...
print(predict('I recommend not to buy, i have ordered 100 gms classic, the coffee was spliting outside the packet.Later today we have opened it to consume then we have noticed that pack seal is open and filled tightly to the brink which i have never encountered earlier. Doubt that the content might be replaced. It is unacceptable in corona scenario. More over they sell with the condition of non replacement.'))